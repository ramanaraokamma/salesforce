...
<!-- this stylesheet decl is for Netscape 6+ -->
   ...
   <xsl:output method = "html" />
    ...
    <xsl:template match="/">
       ...
       <head></head>
       <body>
       <p><i>[FYI, This browser chose this XSL stylesheet which is meant for IE6+ and Netscape 6.1+]</i></p>
